...
const TermsCondition = () => {
  return (
    <View style={styles.termsCondition}>
      ...
      <ScrollView style={styles.outerTermsCondition}>
        <Text style={styles.termsConditionHeading}> Terms and Conditions </Text>

        <Text style={styles.termsConditionText}>
          
          • This application is designed, developed and maintained by Department of
          Information Technology & Communication (DoIT&C) and content provided
          by concern Department/District Administration.
        </Text>
        ...
        <Text style={styles.termsConditionText}> 
          ...
          • The information posted on this application could include hypertext links
          or pointers to information created and maintained by non-Government /
          private organizations. Concern Department/District Administration, is
          providing these links and pointers solely for your information and
          convenience. When you select a link to an outside application, you are
          leaving the Concern Department/District Administration, application and
          are subject to the privacy and security policies of the owners /
          sponsors of the outside application.
        </Text>
